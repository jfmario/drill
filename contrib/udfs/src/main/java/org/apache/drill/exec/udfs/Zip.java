...
public class Zip {
    @FunctionTemplate(name = "zip",
      scope = FunctionTemplate.FunctionScope.SIMPLE,
      isVarArg = true,
      nulls = FunctionTemplate.NullHandling.NULL_IF_NULL)
    public static class VarArgZip implements DrillSimpleFunc {
      @Param
      RepeatedIntHolder[][] inputs;
...
/*
  ...
  public static class IntZip3 implements DrillSimpleFunc {
    ...
    public void eval() {
      new org.apache.drill.exec.udfs.ZipWriter().writeInt(writer, in1, in2, in3);
    }
  }
  ...
  public static class IntZip4 implements DrillSimpleFunc {
    ...
    public void eval() {
      new org.apache.drill.exec.udfs.ZipWriter().writeInt(writer, in1, in2, in3, in4);
    }
  }
  ...
  public static class FloatZip2 implements DrillSimpleFunc {
    ...
    public void eval() {
      new org.apache.drill.exec.udfs.ZipWriter().writeFloat8(writer, in1, in2);
    }
  }
  ...
  public static class FloatZip3 implements DrillSimpleFunc {
    ...
    public void eval() {
      new org.apache.drill.exec.udfs.ZipWriter().writeFloat8(writer, in1, in2, in3);
    }
  }
  ...
  public static class FloatZip4 implements DrillSimpleFunc {
    ...
    public void eval() {
      new org.apache.drill.exec.udfs.ZipWriter().writeFloat8(writer, in1, in2, in3, in4);
    }
  }*/
}
