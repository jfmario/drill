...
public class HttpdDrillLogRecord implements Writable {
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof HttpdDrillLogRecord)) {
      return false;
    }

    HttpdDrillLogRecord that = (HttpdDrillLogRecord) o;
  ...
  @Override
  public int hashCode() {
    return Objects.hash(stringValues, longValues, doubleValues, stringSetValues);
  }
    ...
    if (value != null) {
      for (Map.Entry<String, String> stringSetPrefix : stringSetPrefixes.entrySet()) {
        ...
        if (name.startsWith(prefix)) {
          stringSetValues.get(stringSetPrefix.getValue()).put(name.substring(prefix.length()), value);
        }
      }
    }
  }
