...
public class MongoPushDownFilterForScan extends StoragePluginOptimizerRule {
  ...
  public void onMatch(RelOptRuleCall call) {
    ...
    // When not, push these conditions down again
    ...
    // Passed the filter in, and has scanned the data based on it.
    ...
    // The predicate has been pushed down
    ...
    if (mongoFilterBuilder.isAllExpressionsConverted()) {
       ...
       */
      // Indicates that the conversion was successfully converted into this expression.
      call.transformTo(newScanPrel);
    } else {
      // Since some filter is not completely pushed down, I have to copy it here.
